"""
Entity package for hellofresh.

Architecture:
    All platform entities inherit from (PlatformEntity, HelloFreshEntity).
...
See entity/base.py for the HelloFreshEntity base class.
"""

from .base import HelloFreshEntity

__all__ = ["HelloFreshEntity"]
