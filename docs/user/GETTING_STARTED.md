...
This guide will help you install and set up the HelloFresh custom integration for Home Assistant.
...
5. Add this repository URL: `https://github.com/pantherale0/ha-hellofresh`
6. Set category to "Integration"
7. Click "Add"
8. Find "HelloFresh" in the integration list
9. Click "Download"
10. Restart Home Assistant

### Manual Installation

1. Download the latest release from the [releases page](https://github.com/pantherale0/ha-hellofresh/releases)
2. Extract the `hellofresh` folder from the archive
3. Copy it to `custom_components/hellofresh/` in your Home Assistant configuration directory
...
4. Select entities from "HelloFresh"
...
- Report issues at [GitHub Issues](https://github.com/pantherale0/ha-hellofresh/issues)

## Support

For help and discussion:

- [GitHub Discussions](https://github.com/pantherale0/ha-hellofresh/discussions)
