...
- `entity/` — Base entity class (`HelloFreshEntity`)
...
- Entity MRO: `(PlatformEntity, HelloFreshEntity)` — order matters
...
- Debug level: `custom_components.hellofresh: debug` in `config/configuration.yaml`
